...
class ActivityList : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Controller.getKnowledge().folders != null) {
            for (folder in Controller.getKnowledge().folders!!) {
                if (folder.contentCount > 0) {
                    ...
                    if (folder.folders != null) {
                        for (innerFolder in folder.folders) {
                            ...
                            innerTextView.text = innerFolder.name
                    ...
                    if (folder.articles != null) {
                        for (innerArticle in folder.articles) {
                            val innerTextView = TextView(this)
                            innerTextView.text = innerArticle.name
        ...
        if (Controller.getKnowledge().articles != null) {
            for (article in Controller.getKnowledge().articles!!) {
                val textView = TextView(this)
